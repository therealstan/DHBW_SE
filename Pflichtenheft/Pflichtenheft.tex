...
\begin{table}[ht]
	...
	\begin{table}[ht]
		\begin{tabular} [ll]
			\textbf{Richtigkeit} & Da das System mit persönlichen und sensiblen Daten arbeitet, sollte dieses eine hohe Richtigkeit haben\\
			\textbf{Fehlertoleranz} & Bei der Berechnung der Noten sollten so wenig Fehler wie möglich auftreten \\
			\textbf{Wiederherstellbarkeit} & Die Daten des Systems müssen entsprechend der jeweiligen Anforderung der Hochschule über einen längeren Zeitraum einsehbar und wiederherstellbar sein \\
			\textbf{Modifizierbarkeit} & Die Veranstaltung sollte gut modifizierbar sein, damit der Dozent diese an seine Anforderungen anpassen kann\\
		\end{tabular}	
	\end{table}
...
>>>>>>> c04956e324020844c8fa54c7f39ab8254edaa99e
