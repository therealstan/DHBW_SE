...
\begin{table}[ht]
	...
	Die Benutzeroberfläche entspricht den modernen Ansprüchen der Web-Anwendungen und wird mit entsprechend Google-Designrichtlinien erstellt. UI/UX werden an den Zielgruppen getestet. Die intuitive Bedienung ist eine Voraussetzung.
 ...
 \begin{appendix}
  \section{Begriffsdefinitionen}
	\begin{description}[\setlabelphantom{xxxxxxxxx}]
	\item[bla] dddd
	\item[text] fff
	\end{description}
  \section{Abkürzungen}
