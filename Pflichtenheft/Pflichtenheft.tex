...
\begin{table}[ht]
	...
	Das System läuft auf einem Server , welcher die Anfragen der webbasierten Clients entgegennehmen kann. Die GUI, welche über den Web-Browser angezeigt werden kann ist erst im nächsten Entwicklungsstadium bereitgestellt.
