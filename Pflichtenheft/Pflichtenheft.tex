...
\begin{document}
	...
	\begin{tabular}{ll}
	 \textbf{Use Case ID} & 1 \\
 	 \textbf{Elemntarer Geschäftsprozess} & /F10/ Veranstaltung planen \\ 
	 ...
	 \textbf{Nachebdingung Erfolg} & Veranstaltung ist angelegt \\ 
	...
	\end{table}
		...
		\begin{tabular}{ll}
		 \textbf{Use Case ID} & 2 \\
	 	 \textbf{Elemntarer Geschäftsprozess} & /F20/ Template erstellen \\ 
		 \textbf{Ziel des Use Cases} & Templates für die Veranstaltungen können \\& angelegt werden   \\
		 \textbf{Umgebende Systemgrenze}& Veranstaltungskonfigurator \\ 
		 \textbf{Vorbedingung} & Dozent ist angemeldet \\ 
		 \textbf{Nachebdingung Erfolg} & Template ist erstellt \\ 
		 \textbf{Beteiligte Nutzer:} & Dozent \\ 
		...
		\end{table}
			...
			\begin{tabular}{ll}
			 \textbf{Use Case ID} & 3 \\
		 	 \textbf{Elemntarer Geschäftsprozess} & /F20/ Bewerten \\ 
			 ...
			 \textbf{Nachebdingung Erfolg} & Teilbewertung liegt vor \\
			...
			\begin{tabular}{ll}
			 \textbf{Use Case ID} & 5 \\
		 	 \textbf{Elemntarer Geschäftsprozess} & /F20/ Teilnehmer anlegen \\ 
			 \textbf{Ziel des Use Cases} & Prüfer oder Dozent konfigurieren \\& die Tilnehmer einer Veranstaltung  \\
			 \textbf{Umgebende Systemgrenze} & Planung Prüfung \\ 
			 \textbf{Vorbedingung} & Veranstaltung ist konfiguriert \\
			 \textbf{Nachebdingung Erfolg} & Veranstaltung ist freigegeben\\
	...
	Im folgenden sind die Produktfunktionen aus den Ablaufdiagrammen Dokumentiert. Diese Produktfunktionen werden im Laufe der Entwicklung angepasst und bekommen eine Erweiterung ihren Umfangs.
	...
	\begin{tabular}{ll}
		\multicolumn{2}{l}{/\textbf{\textit{F10}}/}\\\hline
		 ...
		 & 4. Dozent kann Studenten/Gruppen der  Varanstaltung zuweisen\\
		  \textbf{Erweiterung} &  \\ 
...
\begin{table}[ht]
 ...
 \begin{appendix}
  \section{Begriffsdefinitionen}
	\begin{description}[\setlabelphantom{xxxxxxxxxxxxxx}]
		\item[Dozent] text
		\item[Item]
		\item[H$_2$]
		\item[R$_2$S]
